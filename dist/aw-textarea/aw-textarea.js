...
var AwTextArea = (function () {
    function AwTextArea() {
        this.formUpdated = new core_1.EventEmitter();
    }
    AwTextArea.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AwTextArea.prototype.focus = function () {
        this.myInput.nativeElement.focus();
    };
    AwTextArea.prototype.inputValueChangedEvent = function (value) {
    ...
    AwTextArea.prototype.buildFromControl = function (inputFieldDefinition) {
        return new forms_1.FormControl(inputFieldDefinition.defaultValue || '', inputFieldDefinition.validators);
    };
    AwTextArea.prototype.prepareTextInputFieldDefinition = function (textInputFieldDefinition) {
